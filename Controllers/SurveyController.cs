...
namespace AGsite.Controllers
{
    public class SurveyController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FirstName,LastName,Email,SingleAnswer,Answer")] SurveyData surveyData)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Email,SingleAnswer,Answer")] SurveyData surveyData)
        {
            if (id != surveyData.Id)
            {
                return NotFound();
